class UpgradeDefense extends DefenseTower {

  PImage upgrade;
  
  UpgradeDefense(PVector pos, int health, PVector dim) {
    super(pos, health, dim);
    
    upgrade = loadImage("upgradeDefense.png");
  }
  ...
  void render() {
    ...
    scale(0.3);
    image(upgrade, -upgrade.width/2, -upgrade.height/2);
    popMatrix();
  }
